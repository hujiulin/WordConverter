...
namespace ConvertWordToHTML
{
    public class WordOperation
    {
        ...
        #region Convert Method: doc to specified .ext
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        public bool WordToFile(string strSaveFileName, enumEXT targetExt)
        { 
                ...
                switch (targetExt)
                {
                    case enumEXT.pdf:
                        docType.InvokeMember("SaveAs", System.Reflection.BindingFlags.InvokeMethod, null, _Document,
                                             new object[] { saveFileName, Microsoft.Office.Interop.Word.WdSaveFormat.wdFormatPDF }
                                             );
                        break;
                    case enumEXT.html:
                    default:
